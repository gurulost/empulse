...
- [ ] Q-500 [status:in_progress] EMP-501–504: PostgreSQL/process CI, static/security gates, Vue tests, and full browser journeys.
  - Evidence: CI definition, local PostgreSQL run, static analysis, audits, license review, unit/build gates, and all 13 browser journeys pass; committed-SHA GitHub execution and Gitleaks remain.
